...
GEMINI_FALLBACK_MODEL = env_str("GEMINI_FALLBACK_MODEL", "gemini-2.5-flash")
CHAT_STATS_ENABLED = env_bool("CHAT_STATS_ENABLED", True)
CHAT_STATS_PAGE_ID = env_str("CHAT_STATS_PAGE_ID", "38173fbd195180a8a0f1d7bffbc221da")
